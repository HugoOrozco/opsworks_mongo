...
# Key file contents
default['mongodb3']['config']['key_file_content'] = 'n/XmT8wIOmKSwVqV5UPUcEf23ugCoL6uRVV0C2u9Ilg0+pb2SfS5vWYvXY7UhL6J
...
default['mongodb3']['config']['mongod']['security']['keyFile'] = '/var/lib/keyfile'
